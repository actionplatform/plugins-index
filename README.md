...
```json
{
  ...
  "author": "you",
  "verified": false,
  "repo": "https://github.com/you/action-platform-plugin-slug",
  "pypi": "action-platform-plugin-slug",
  "latest": "1.0.0",
  "min_core": "0.16",
...
- `pypi` must start with `action-platform-plugin-`; the slug must not collide with a core tool or a reserved word (`core platform official admin system test internal`).
